...
class TrainManager(object):
    ...
    def train(self):
        ...
        best_srcc = 0
        model_path = os.path.join(self._data['para_saving_path'], (str(self._options['iter_number'])+ '_' + str(self._options['frame_number']) + '.pkl'))
...
if __name__ == '__main__':
    ...
    data['per_save_file'] = os.path.join(data['para_saving_path'], 'performance_'+str(args.iter_number)+'_'+str(args.frame_number)+'.txt')
